...
def load_args():
    ...
    parser.add_argument('--dataset', type=str, default='CIFAR10',
                        choices=['MNIST', 'FashionMNIST', 'CIFAR10', 'CIFAR100',"mushrooms","w8a", "rcv1", "ijcnn","a1a","a2a","a3a","w1a","phishing", "Flower102"],
    ...
    parser.add_argument('--log_step_length_folder', type=str, default='../logs',
                        help='Where to store step length results.')
                       
    parser.add_argument('--run', type=int, default=1,
                        help='the run number (default: 1).')
